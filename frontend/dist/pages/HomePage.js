...
var TaskItem_1 = __importDefault(require("../components/TaskItem"));
var TasksForm_1 = __importDefault(require("../components/TasksForm"));
var HomePage = function () {
    ...
    return (react_1.default.createElement("div", { className: "container mx-auto p-4" },
        react_1.default.createElement("div", { className: "flex flex-wrap -mx-4" },
            react_1.default.createElement("div", { className: "w-full md:w-1/2 px-4" },
                react_1.default.createElement("h1", { className: "text-2xl font-bold mt-6 mb-4 text-center " }, "All Tasks"),
            ...
            react_1.default.createElement("div", { className: "w-full md:w-1/2 px-4" },
                react_1.default.createElement("h1", { className: "text-2xl font-bold mb-4 text-center" }, "Create Task"),
